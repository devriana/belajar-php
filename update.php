...
<body>
    ...
    <form action="update.php" method="post">
        ...
        Tempat Lahir: <input type="text" name="tpt_lahir" value="<?php echo $mahasiswa['tempat_lajir']; ?>"><br>
        ...
        <input type="number" name="alamat" value="<?php echo $mahasiswa['id'] ?>" hidden>
